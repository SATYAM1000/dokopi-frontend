          ...
          <div className="rounded-lg bg-black bg-opacity-80 backdrop-blur">
            <div className="flex w-full flex-wrap items-center justify-between gap-4 px-8 py-10 sm:px-16 lg:flex-nowrap">
              ...
              <div className="flex flex-wrap items-center justify-center gap-6">
                <button className="bg-blue-600 text-white button-text flex items-center justify-center whitespace-nowrap rounded-md transition-all duration-300 px-8 py-3 text-xs sm:text-sm">
                  Get Started
                </button>
