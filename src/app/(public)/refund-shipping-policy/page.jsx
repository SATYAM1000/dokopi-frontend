    ...
    <>
      <Wrapper>
        <div className="container mx-auto p-4">
          ...
          <ol className="list-decimal ml-6 mb-4">
            ...
            <li className="mb-2">
              ...
              <ul className="list-disc ml-6">
                ...
                <li>
                  If an order is cancelled after the documents have been
                  printed, the full amount will be non-refundable.
                </li>
                <li>
          ...
          <ul className="list-disc ml-6 mb-4">
            <li>
              <strong>Accuracy of Information:</strong> Users are responsible
              for ensuring that the uploaded documents and print specifications
              are accurate. DoKopi is not responsible for any errors in the
              provided files or instructions.
            </li>
            <li>
              <strong>Print Quality:</strong> We strive to ensure high-quality
              printing. If there are any issues with the print quality due to
              our fault, please contact the store directly for assistance.
            </li>
            <li>
