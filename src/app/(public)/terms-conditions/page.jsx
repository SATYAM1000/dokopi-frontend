      ...
      <Wrapper className="w-full my-6 flex flex-col">
        ...
        <article className="flex flex-col border-b border-black/[0.1] pb-4 mb-4">
          ...
          <p className="text-lg my-2">
            ...
            use of DoKopi's Website, located at{" "}
            <Link
          ...
          <p className="text-lg my-2">
            ...
            conditions. Do not continue to use dokopi.com if you do not agree to
        ...
        <article className="flex flex-col border-b border-black/[0.1] pb-4 mb-4">
          ...
          <p className="text-lg my-2">
            We employ the use of cookies. By accessing dokopi.com, you agreed to
            use cookies in agreement with the DoKopi's Privacy Policy.
          </p>
          <p className="text-lg my-2">
        ...
        <article className="flex flex-col border-b border-black/[0.1] pb-4 mb-4">
          ...
          <p className="text-lg my-2">
            Unless otherwise stated, DoKopi and/or its licensors own the
            intellectual property rights for all material on dokopi.com. All
            intellectual property rights are reserved. You may access this from
            dokopi.com for your own personal use subjected to restrictions set
        ...
        <article className="flex flex-col border-b border-black/[0.1] pb-4 mb-4">
          ...
          <p className="text-lg my-2">
            ...
            DoKopi does not filter, edit, publish or review Comments prior to
            their presence on the website. Comments do not reflect the views and
            opinions of DoKopi, its agents and/or affiliates. Comments reflect
            the views and opinions of the person who post their views and
            opinions. To the extent permitted by applicable laws, DoKopi shall
            not be liable for the Comments or for any liability, damages or
            expenses caused and/or suffered as a result of any use of and/or
            posting of and/or appearance of the Comments on this website.
          </p>
          <p className="text-lg my-2">
            DoKopi reserves the right to monitor all Comments and to remove any
          ...
          <ul className="text-lg my-2 flex flex-col gap-2">
            <li>
              <span className="mr-2">&#9679;</span>You are entitled to post the
              Comments on our website and have all necessary licenses and
              consents to do so;
            </li>
            <li>
              <span className="mr-2">&#9679;</span>The Comments do not invade
              any intellectual property right, including without limitation
              copyright, patent or trademark of any third party;
            </li>
            <li>
              <span className="mr-2">&#9679;</span>The Comments do not contain
              any defamatory, libelous, offensive, indecent or otherwise
              unlawful material which is an invasion of privacy;
            </li>
            <li>
              <span className="mr-2">&#9679;</span>The Comments will not be used
              to solicit or promote business or custom or present commercial
              activities or unlawful activity.
            </li>
          </ul>
          <p className="text-lg my-2">
            You hereby grant DoKopi a non-exclusive license to use, reproduce,
        ...
        <article className="flex flex-col border-b border-black/[0.1] pb-4 mb-4">
          <h3 className="md:text-3xl font-medium mt-4 text-xl">
          ...
          <ul className="text-lg my-2 flex flex-col gap-2">
            <li>
              <span className="mr-2">&#9679;</span>Government agencies;
            </li>
            <li>
              <span className="mr-2">&#9679;</span>Search engines;
            </li>
            <li>
              <span className="mr-2">&#9679;</span>News organizations;
            </li>
            <li>
              <span className="mr-2">&#9679;</span>Online directory distributors
              may link to our Website in the same manner as they hyperlink to
              the Websites of other listed businesses; and
            </li>
            <li>
              <span className="mr-2">&#9679;</span>System wide Accredited
          ...
          <ul className="text-lg my-2 flex flex-col gap-2">
            <li>
              <span className="mr-2">&#9679;</span>commonly-known consumer
              and/or business information sources;
            </li>
            <li>
              <span className="mr-2">&#9679;</span>dot.com community sites;
            </li>
            <li>
              <span className="mr-2">&#9679;</span>associations or other groups
              representing charities;
            </li>
            <li>
              <span className="mr-2">&#9679;</span>online directory
              distributors;
            </li>
            <li>
              <span className="mr-2">&#9679;</span>internet portals;
            </li>
            <li>
              <span className="mr-2">&#9679;</span>accounting, law and
              consulting firms; and
            </li>
            <li>
              <span className="mr-2">&#9679;</span>educational institutions and
              trade associations.
            </li>
          </ul>
          <p className="text-lg my-2">
            ...
            visibility of the hyperlink compensates the absence of DoKopi; and
          ...
          <p className="text-lg my-2">
            ...
            sending an e-mail to DoKopi. Please include your name, your
          ...
          <ul className="text-lg my-2 flex flex-col gap-2">
            <li>
              <span className="mr-2">&#9679;</span>By use of our corporate name;
              or
            </li>
            <li>
              <span className="mr-2">&#9679;</span>By use of the uniform
              resource locator being linked to; or
            </li>
            <li>
              <span className="mr-2">&#9679;</span>By use of any other
              description of our Website being linked to that makes sense within
              the context and format of content on the linking party's site.
            </li>
          </ul>
          <p className="text-lg my-2">
            No use of DoKopi's logo or other artwork will be allowed for linking
        ...
        <article className="flex flex-col border-b border-black/[0.1] pb-4 mb-4">
          ...
          <ul className="text-lg my-2 flex flex-col gap-2">
            <li>
              <span className="mr-2">&#9679;</span>limit or exclude our or your
            ...
            <li>
              <span className="mr-2">&#9679;</span>limit any of our or your
              liabilities in any way that is not permitted under applicable law;
              or
            </li>
            <li>
              <span className="mr-2">&#9679;</span>exclude any of our or your
